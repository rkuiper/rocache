#' @name rocache
#' @title rocache: Efficient Caching for R Objects
#' @docType package
#' @description
...
#' - Customizable Control: The caching mechanism in 'rocache' puts you in charge, allowing you to specify the caching behavior and expiration policies that best suit your workflow.
#' - Seamless Integration: 'rocache' integrates smoothly with your existing code and workflows, minimizing any additional effort required to implement caching.
#'
...
#'
#' ## Exported function
#' `r library(rocache); pkg_ns <- getNamespace("rocache"); paste0(ls(pkg_ns, all.names = FALSE),collapse=", ")`
#'
#' @keywords caching reproducibility efficiency R
NULL
